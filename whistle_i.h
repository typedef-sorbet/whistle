...
void (*const whistle_scene_on_enter_handlers[])(
    void*) = {mainmenu_on_enter, options_on_enter, file_browser_on_enter, transfer_on_enter};
bool (*const whistle_scene_on_event_handlers[])(void*, SceneManagerEvent) =
    {mainmenu_on_event, options_on_event, file_browser_on_event, transfer_on_event};
void (*const whistle_scene_on_exit_handlers[])(
    void*) = {mainmenu_on_exit, options_on_exit, file_browser_on_exit, transfer_on_exit};
